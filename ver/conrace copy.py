import time
import threading
CANTIDAD_INICIAL_HAMBURGUEZAS = 1000
cantidad_de_hamburguezas = CANTIDAD_INICIAL_HAMBURGUEZAS
hilo1 = 0
hilo2 = 0
acumulador = 0
...
def restador(t,operacion):
    ...
    global hilo1
    global hilo2
    global rangcantidad_de_hamburguezaso
    
    while cantidad_de_hamburguezas >0:
            if(cantidad_de_hamburguezas <= 0):
               print("fin")
               break
            if t=="1":
                hilo1 +=1
